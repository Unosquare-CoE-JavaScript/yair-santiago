...
import { Button, Col, Form, FormGroup, Input, Label, Popover, Row } from "reactstrap";
            ...
            <Row className="justify-content-center">
                <Col md={12}>
                    <FormGroup>
                        ...
                        <Popover target="popover-tc" toggle={togglePopover} isOpen={popoverOpen}>
                            No ice cream will actually be delivered
                        </Popover>
                    </FormGroup>
                </Col>
                <Col md={5}>
                    <Button color="primary" type="button" disabled={!tcAgreed} onClick={onSubmit}>
                        Confirm order
                    </Button>
                </Col>
            </Row>
